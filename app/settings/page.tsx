...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      {/* Nav */}
      <nav className="flex items-center justify-between px-6 py-4 border-b border-border max-w-4xl mx-auto w-full">
        <Link href="/" className="flex items-center gap-2">
          <Image src="/images/logo.png" alt="NoteRunway" width={36} height={36} />
          <span className="neon-text font-mono font-bold tracking-tight">NoteRunway</span>
        </Link>
        {connected && (
          <Link href="/dashboard" className="neon-btn px-5 py-2 text-xs">
            Go to Dashboard →
          </Link>
        )}
      </nav>
